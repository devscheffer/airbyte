...
import pytest
from source_marvel_api.source import MarvelApiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MarvelApiStream, "path", "v0/example_endpoint")
    mocker.patch.object(MarvelApiStream, "primary_key", "test_primary_key")
    mocker.patch.object(MarvelApiStream, "__abstractmethods__", set())
